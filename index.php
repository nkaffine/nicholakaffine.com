<?php
    ...
    $nav->addToLeftList("aboutme", new PageListItem("About Me", "/#aboutme"));
    ...
    $page->addToBody("<img id=\"mainimg\" src=\"/images/slider/IMG_0509.JPG\"
...
<div class=\"panel hidden-lg box col-xs-12 \">
    ...
    $applescript = new AboutSubCategory("The Start (Applescript)", "My first significant coding experience was with Applescript. I discovered Applescript in my
            ...
            speech recognition server and Spotify integration to create a <a
                ...
                script</a>.", null);
    $webDev = new AboutSubCategory("Web Dev", "I first started doing web development seriously when I started working on my first startup,
            Owaygo.
            ...
            project and my
            <a href=\"https://github.com/nkaffine/budgeting\" target=\"_blank\">budgeting website project.</a>", null);
    ...
    $musicbackground = new AboutSubCategory("Background", "I started playing guitar when I was 6 with ambitions of being either a musician or a baseball
            player.
            ...
            no one will ever here it again.", null);
    $jumbotronica = new AboutSubCategory("Jumbotronica", "In July of 2015 I was lost in thought and I came up with the name Jumbotronica. \"What a great
            name for an
            ...
            three days.
            In december of 2015 I decided to shift my project to the band that I was in at the time, The Accidents.",
        "https://soundcloud.com/jumbotronica");
    $theaccidents = new AboutSubCategory("The Accidents", "he debut of The Accidents was in early january in 2016 when we performed <a
            ...
            our schedules.", "http://theaccidents.band");
    ...
    $page->addToBody("</div>
        <div class=\"col-xs-12 bottom\"></div>", Page::BOTTOM);
